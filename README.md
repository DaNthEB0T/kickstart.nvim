...
```sh
git clone git@github.com:DaNthEB0T/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone git@github.com:DaNthEB0T/kickstart.nvim.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone git@github.com:DaNthEB0T/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
